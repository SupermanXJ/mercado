...
To bill a sale, you need to obtain the buyer's tax data through the API
**/orders/order\_id/billing\_info**
...
-   When the buyer's billing data indicates the generic RFC
    XAXX010101000, it means that the buyer did not request a nominal
    invoice. In this case, the seller will have the freedom to decide
    whether to issue a generic invoice or a global invoice.
